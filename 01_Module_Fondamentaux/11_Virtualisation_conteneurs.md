...
Nous sommes en 2002, une entreprise possède un serveur.
...
À l'époque, c'était une machine très puissante, l'entreprise installe :
...
Une machine virtuelle est : Un ordinateur logiciel.
...
L'hyperviseur est un logiciel très spécial. Il partage :
...
Prenons une VM Ubuntu. Elle contient :
...
En 2013, un problème se pose. Les développeurs veulent lancer rapidement des applications.
...
Souvienez-vous du chapitre sur les processus. Le noyau Linux sait déjà isoler les processus.
...
Kubernetes ne lance pas directement des applications. Il orchestre des **conteneurs**.
