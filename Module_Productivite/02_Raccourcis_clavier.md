...
Il ne quitte jamais le clavier.
...
Parce qu'il ne perd jamais de temps à déplacer sa main.
...
Le raccourci que tu utiliseras le plus :
...
Si plusieurs fenêtres sont ouvertes :

Alt + `

(la touche située à gauche du 1 sur un clavier AZERTY).
...
À utiliser dès que tu t'absentes.

Un bon réflexe en entreprise.
...
(selon la configuration GNOME).

Tu peux aussi afficher les bureaux avec Super.
...
Les raccourcis que j'utilise tous les jours.
...
Tu l'utiliseras des milliers de fois.
...
Aller à la fin
Ctrl + E
Effacer jusqu'au début
Ctrl + U
Effacer jusqu'à la fin
Ctrl + K
Effacer un mot précédent
Ctrl + W
...
Ce n'est pas pour faire le "geek".

C'est simplement plus efficace.
...
Module 02 – Chapitre 2
Les raccourcis clavier

Voici ceux que je connais par cœur.

Les indispensables Ubuntu
Ouvrir un terminal
Ctrl + Alt + T
...
Je n'utilise quasiment jamais le menu Applications.
...
Mettre une fenêtre à gauche
Super + ←
Mettre une fenêtre à droite
Super + →
...
C'est probablement mon raccourci préféré.
...
Jamais je ne tape un long chemin complet.

Les raccourcis qui changent une carrière

Pour moi, les cinq plus importants sont :
...
Tu vas les utiliser plusieurs centaines de milliers de fois dans ta carrière.

Les erreurs des débutants

❌ Tout retaper.

❌ Utiliser la souris pour ouvrir le terminal.

❌ Copier-coller des chemins.

❌ Ne jamais utiliser l'historique.
...
Je touche très rarement à la souris.