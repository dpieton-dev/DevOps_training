...
Son garage est en désordre, les clés sont partout. Les tournevis sont mélangés. Les vis traînent au sol.
...
## Votre poste de travail est un laboratoire

Pendant toute cette académie, votre ordinateur ne sera plus un simple PC. Il deviendra :
...
Vous m'avez déjà fourni les informations de votre machine.
...
Le bureau que vous voyez n'est qu'une application parmi d'autres. Ce n'est pas Linux.
...
Le terminal est simplement une fenêtre. À l'intérieur de cette fenêtre fonctionne un programme appelé : **Shell**
...
Le terminal et le shell sont deux choses différentes. C'est une confusion très fréquente.
...
Le terminal est : le téléphone

Le shell est : la personne qui répond

Le téléphone n'effectue aucun travail mais la personne oui.

---

## Le Shell

Le shell est un interpréteur. Vous écrivez :
```bash
ls
```

Le shell comprend cette commande, puis il demande au noyau de lancer le programme correspondant.

Souvienez-vous du Module 01 :
...
Votre dossier personnel est : **/home/dominique**

C'est ton espace privé, il contient :
...
Dans ~/devopslab, je vous propose l'organisation suivante :
...
Un ingénieur passe son temps entre quelques outils, environ :
...
Vous changez de bureau sans fermer tes applications. C'est extrêmement pratique lorsqu'on gère plusieurs environnements.

---

## Une journée d'un DevOps

Imagine une matinée classique. Vous avez :
...
Vous passez constamment de l'un à l'autre. L'objectif est de le faire sans perdre le fil.
...
Vous croyiez être sur ton PC, vous êtes en réalité sur le serveur de production.
...
💥 Catastrophe. Un environnement bien organisé réduit énormément ce type d'erreur.
...
* Votre dossier personnel est ton espace de travail
